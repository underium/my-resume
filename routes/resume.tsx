  ...
  return (
    <>
      ...
      <div class="flex h-screen justify-center items-center flex-col">
        <Header active="false" />
        <div class="p-4 flex-3 w-full h-full mx-auto overflow-scroll">
          <div class="p-4 mx-auto max-w-screen-md bg-white">
            ...
            <section id="contact">
              ...
              <div class="grid-list">
                <div>
                  <h4>Email</h4>
                  <a href="mailto:hola@javiercaceres.es">
                    hola@javiercaceres.es
                  </a>
                </div>
                <div>
                  <h4>Phone</h4>
            ...
            <section id="about">
              ...
              <article>
                <p>
                  ...
                  University of Oklahoma and Stanford. (Go Sooners and
                  Cardinal!) Before starting Pied Piper, he worked for Hooli as
                  a part time software developer. While his work focuses on
                  applied information theory, mostly optimizing lossless
                  compression schema of both the length-limited and adaptive
                  variants, his non-work interests range widely, everything from
                  quantum computing to chaos theory. He could tell you about it,
                  ...
                  <div class="item" id="work-item">
                    <div class="summary">
                      <p>
                        ...
                        merely competitive, but approach the theoretical limit
                    ...
                    <ul class="highlights">
                      <li>
                        <p>
                          ...
                          was violating copy right infringement laws
                        </p>
                      </li>
                      <li>
              ...
              <section id="references">
                <div class="item">
                  <blockquote class="reference">
                    ...
                    performance working as a consultant for Main St. Company
                    proved that he will be a valuable addition to any
                    company.&#32;&#8221;
                  </blockquote>
                  <div class="name">
                    Erlich Bachman
