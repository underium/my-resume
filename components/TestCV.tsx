...
export const TestCV = (props: JSX.HTMLAttributes<HTMLInputElement>) => {
  ...
  return (
    <div
      id="#resume"
      class="flex flex-3 justify-center items-center flex-col overflow-hidden"
    >
      <div class="p-4 mx-auto max-w-screen-md bg-white h-fit">
